...
PreparedStatement prst=con.prepareStatement("insert into UserPost(post,PostDate,UserId,UserName,violance,Vulgur,offensive,hate,clike,dlike,prediction)values(?,?,?,?,?,?,?,?,?,?,?)");
...
prst.setString(9, "0");
prst.setString(10, "0");	
prst.setString(11, request.getParameter("r1"));	
